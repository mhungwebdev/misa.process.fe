<template>
    ...
    >
        ...
        <template #cellControl="{ data }">
            <div class="msp-cell-control-wrapper flex align-items-center flex-end h-full w-full">
                <div @click="$emit('editRow',data.key)" class="msp-cell-control border-circle flex-center m-r-8">
                    <div class="msp-cell-control-update"></div>
                </div>

                <div @click="$emit('deleteRow',data.key)" class="msp-cell-control border-circle flex-center">
